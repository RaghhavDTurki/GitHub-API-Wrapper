...
import { GetStargazersWithExactly2Stars } from "../../../types/InputTypes";
import { Octokit } from "octokit";
import { iterate } from "../../../utils/cleanData";

export const getStargazersWithExactly2Stars = async (req: Request, res: Response) => {
    try {
        ...
        const body = req.body as GetStargazersWithExactly2Stars;
        if (body.username) {
